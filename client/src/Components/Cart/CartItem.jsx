...
const CartItem = ({ data }) => {
  ...
  return (
    <Row className="border-[1px] border-gray-400 rounded mb-[30px] items-center w-full py-[10px] px-[20px] ">
      <Row className="w-[20%] ">
        <img
      ...
      <p className="w-[20%] text-[16px] text-black text-center font-medium">
        ${getTotal()}
      </p>
    </Row>
  );
